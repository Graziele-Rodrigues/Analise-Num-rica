...
## @deftypefn {} {@var{integral},@var{Delta},@var{Iter},@var{info} =} gauss_legendre_dupla(@var{ax},@var{bx},@var{nx},@var{ay},@var{by},@var{ny},@var{f})
##
## Entradas:
...
##(info =0:paramentros sao consistentes e todos os zeros convergiram;Info=-1:nx<1 || ny<1; info=k:k zeros nao covergiram)
