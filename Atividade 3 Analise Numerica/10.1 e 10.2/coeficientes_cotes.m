%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% objetivo: fornecer os parametros da formula de Newton-cotes.
%
%
%  Entradas:
%          n->grau do polinomio integracao
%  Saidas:
%          Den->denominador da forma geral
%          VetC->vetor com os coeficientes de cotes
%          info->informaca sobre consistencia
%          equação:      (info=0:1<=n<=10, e info =-1:n<1 ou n>10)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
